...
public class RSAPublicKey: Key {
    ...
    public static func publicKeys(pemEncoded pemString: String) -> [RSAPublicKey] {
        ...
        let keys = matches.compactMap { result -> RSAPublicKey? in
            ...
            return try? RSAPublicKey(pemEncoded: String(thisKey))
        }
