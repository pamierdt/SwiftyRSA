...
public class ClearMessage: Message {
    ...
    /// - Throws: SwiftyRSAError
    public func encrypted(with key: RSAPublicKey, padding: Padding) throws -> EncryptedMessage {
    ...
    /// - Throws: SwiftyRSAError
    public func verify(with key: RSAPublicKey, signature: Signature, digestType: Signature.DigestType) throws -> Bool {
